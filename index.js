  ...
  cors({
    origin: function (origin, callback) {
      if (!origin || 
         ...
         origin.includes("devtunnels.ms") || // ✅ Allow VS Code DevTunnel URLs
        origin.includes("onrender.com")     // ✅ Allow Render preview
      ){
        callback(null, true);
      } else {
...
app.use("/api/waiting-users", waitingUserRoutes); // ✅ New live waiting users API

// ✅ Root route
app.get("/", (req, res) =>
  res.send("🚀 Interview Test Portal API is running...")
);
